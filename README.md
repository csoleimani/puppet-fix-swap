...
2. [Setup - The basics of getting started with fixswap](#setup)
    * [What fixswap affects](#what-fixswap-affects)
    * [Setup requirements](#setup-requirements)
    * [Beginning with fixswap](#beginning-with-fixswap)
